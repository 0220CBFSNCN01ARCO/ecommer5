...
-- -----------------------------------------------------
-- Table `mercadolibro`.`autores`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mercadolibro`.`autores` ;

CREATE TABLE IF NOT EXISTS `mercadolibro`.`autores` (
...
-- -----------------------------------------------------
-- Table `mercadolibro`.`categorias`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mercadolibro`.`categorias` ;

CREATE TABLE IF NOT EXISTS `mercadolibro`.`categorias` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
  `idLibro` INT(11) NOT NULL,
  PRIMARY KEY (`id`))
...
CREATE TABLE IF NOT EXISTS `mercadolibro`.`libros` (
  ...
  INDEX `fk_libros_usuarios1_idx` (`idUsuario` ASC) VISIBLE,
  CONSTRAINT `fk_libros_categoria1`
    FOREIGN KEY (`idCategoria`)
    REFERENCES `mercadolibro`.`categorias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_libros_usuarios1`
    FOREIGN KEY (`idUsuario`)
    REFERENCES `mercadolibro`.`usuarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `mercadolibro`.`libros_autores` (
  ...
  CONSTRAINT `fk_libros_has_autor_autor1`
    FOREIGN KEY (`idAutor`)
    REFERENCES `mercadolibro`.`autores` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
